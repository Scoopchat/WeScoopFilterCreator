...
kernel void lutKernelOriginProject( texture2d<float, access::read_write> outputImage  [[texture(1)]],
                                   texture2d<float, access::sample> inputLUT  [[texture(0)]],
                                   constant float &intensity  [[buffer(0)]],
                                   uint2 gid [[thread_position_in_grid]]) {
...
kernel void denoiserKernel( texture2d<float, access::read_write> outputImage  [[texture(1)]],
                           texture2d<float, access::sample> inputLUT  [[texture(0)]],
                           constant float &intensity  [[buffer(0)]],
                           uint2 gid [[thread_position_in_grid]]) {
    ...
    float4 textureColor = inputLUT.read(gid);
